...
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9][0-9][G]"       | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9],[0-9][G]"      | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9][0-9][0-9][M]"  | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9][0-9][M]"       | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9],[0-9][M]"      | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9][0-9][0-9][K]"  | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9][0-9][K]"       | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
#du -sh ./20youtub*/*/*/*.mp4 ./202*/*/*.mp4 ./music/*/*.mp4 2>/dev/null | grep "^[1-9],[0-9][K]"      | sort -r | awk '{$1 = ""; sub($1 FS, ""); print}' >> "playlist_nach_größe_gk.txt"
